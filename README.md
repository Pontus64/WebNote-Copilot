...
```html
<script
  src="/embed/inject-floating-notes.js?v=1.0.17"
...
```html
<script
  src="http://127.0.0.1:5174/embed/inject-floating-notes.js?v=1.0.17"
...
```html
<script
  src="https://notes.edmund.xin/embed/inject-floating-notes.js?v=1.0.17"
...
```js
// @version      1.0.17
// @require      https://notes.edmund.xin/embed/floating-notes-widget.js?v=1.0.17
...
例如从 `1.0.16` 升到 `1.0.17`。这样可以避免浏览器、宿主页或 Tampermonkey 继续使用旧的 loader/widget 缓存。
